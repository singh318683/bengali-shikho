...
window.APP_CONFIG = {
  ...
  storageKey: 'bengali-shikho-v2',

  // true  = play the recorded/generated files in /audio (recommended).
  // false = use the phone's built-in voice, which most iPhones do not have for Bengali.
  ...
  // Example: 'https://forms.gle/xxxx' or 'mailto:you@example.com?subject=Bengali%20app%20feedback'
  feedbackUrl: ''
};
