...
## First-time setup
```
git clone https://github.com/singh318683/bengali-shikho
cd bengali-shikho/ios-app
npm install
npm run add:ios
npm run open
```
...
2. Tick "Automatically manage signing" and choose your Team. The bundle identifier is `com.ikshana.bengalishikho`.
...
1. In App Store Connect, create a new app with the bundle identifier `com.ikshana.bengalishikho`. If "Bengali Shikho" is already taken as the app name, use "Learn Bengali: Shikho" instead, matching the naming used for the Gujarati, Punjabi, Telugu and Tamil apps.
...
- Replace `[add your contact email here]` in `privacy.html`, push it, and use `https://bengali-shikho.vercel.app/privacy.html` as the Privacy Policy URL in App Store Connect
